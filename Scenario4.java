...
public class Scenario4 {
	...
	public static void main(String[] args) throws InterruptedException {
       ...
       WebDriverWait wait5 = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait5.until(ExpectedConditions.visibilityOfElementLocated((By.xpath("//button[text()='MOVE TO WISHLIST']"))));
		driver.findElement(By.xpath("//button[text()='MOVE TO WISHLIST']")).click();// add to wishlist
